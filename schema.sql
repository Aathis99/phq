...
--
-- Host: db
-- Generation Time: Feb 10, 2026 at 01:33 PM
...
--
ALTER TABLE `add_caselog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสลำดับเคส (Primary Key)';

--
-- AUTO_INCREMENT for table `assessment`
--
ALTER TABLE `assessment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'idรันaa';

--
-- AUTO_INCREMENT for table `closure_report`
--
ALTER TABLE `closure_report`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรายงาน (Primary Key)';

--
-- AUTO_INCREMENT for table `forward_case`
--
ALTER TABLE `forward_case`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการส่งต่อ (Primary Key)';

--
-- AUTO_INCREMENT for table `images`
--
ALTER TABLE `images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสรูปภาพ (Primary Key)';
